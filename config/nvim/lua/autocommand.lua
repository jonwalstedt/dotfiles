...
--   vim.cmd[[autocmd!]]
--   vim.cmd[[autocmd VimEnter *.md, *.js, *.jsx, *.ts, *.tsx setlocal cursorline]]
--   vim.cmd[[autocmd WinEnter *.md, *.js, *.jsx, *.ts, *.tsx setlocal cursorline]]
--   vim.cmd[[autocmd BufWinEnter *.md, *.js, *.jsx, *.ts, *.tsx setlocal cursorline]]
--   vim.cmd[[autocmd WinLeave *.md, *.js, *.jsx, *.ts, *.tsx setlocal nocursorline]]
-- vim.cmd[[augroup END]]
