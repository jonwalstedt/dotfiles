...
M.setup = function()
  ...
  null_ls.setup {
    ...
    sources = {
      ...
      b.formatting.prettierd.with(opts.prettier_formatting),
      b.formatting.stylua.with(opts.stylua_formatting),
      b.formatting.elm_format.with(opts.elm_format_formatting),
